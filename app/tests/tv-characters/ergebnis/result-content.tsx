...
import { ResultCard } from "@/components/tests/tv-characters/result-card";
import { characterResults } from "@/components/tests/tv-characters/test-data";
import type { Character } from "@/components/tests/tv-characters/types";
...
export function ResultContent({
  ...
  useEffect(() => {
    if (
      ...
      router.push("/tests/tv-characters");
    }
