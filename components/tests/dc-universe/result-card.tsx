    ...
    >
            ...
            <div className="grid grid-cols-2 gap-2 mb-6">
              {Object.entries(result.traits).map(([trait, value]) => (
                <div key={trait} className="flex items-center">
                  <div className={`w-2 h-2 rounded-full ${getTraitColor(value)} mr-2`}></div>
                  <span className="text-gray-300">{traitLabels[trait as Trait]}: </span>
      ...
      <div className="bg-gray-800 p-6">
        ...
        <p className="text-gray-300 mb-4">
          Dieser Persönlichkeitstest basiert auf den Charaktereigenschaften der beliebtesten DC-Helden und -Schurken.
          Die Fragen wurden entwickelt, um deine Persönlichkeitsmerkmale mit denen der Charaktere aus dem DC Extended
          Universe zu vergleichen.
        </p>
